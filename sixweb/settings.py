"""
Django settings for sixweb project.
...
SECRET_KEY = 'django-insecure-+_yc04w!nfguri7+cax^)yk!n!i93*$om)#8ny*_qh_4*6*ejk'
...
WSGI_APPLICATION = 'sixweb.wsgi.application'
...
if USE_MYSQL:
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'sixweb'),
